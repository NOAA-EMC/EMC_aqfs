...
!
! notes:	This routine extends the Fortran "Fm.n" formatting function.
...
subroutine real_to_string (val, decimal, ndigits, trim_opt, string)
   
   implicit none

   real,      intent (in ) :: val		! value to convert to string
   character, intent (in ) :: decimal*1		! decimal point char for output
