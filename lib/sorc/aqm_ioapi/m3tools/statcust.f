...
C...........   ARGUMENTS and their descriptions:
        ...
        REAL		THRESH( 10,NVARS )	! thresholds for counting
        CHARACTER*(*)   INAME                  !  input file logical name
        CHARACTER*(*)   VNAMES( NVARS )         !  list of vble names
...
C   begin body of subroutine  STATCUST
        ...
        IF ( JDATE .NE. 0 .OR. JTIME .NE. 0 ) THEN	
            WRITE( RDEV,92000 )
     &          INAME, JDATE, JTIME, DT2STR( JDATE, JTIME )
        ELSE
            WRITE( RDEV,92010 ) INAME
        END IF
        ...
        DO  111  V = 1, NVARS
            ...
            IF ( VTYPES( V ) .EQ. M3REAL ) THEN
                ...
                IF ( .NOT. READ3( INAME, VNAMES( V ), ALLAYS3,
