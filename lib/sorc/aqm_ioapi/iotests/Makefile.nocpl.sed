...
#
#
CFLAGS = $(ARCHFLAGS) $(PARFLAGS) $(COPTFLAGS)
#
FFLAGS =  -I$(IODIR) -I. $(FOPTFLAGS) $(ARCHFLAGS) $(PARFLAGS)
#
LDFLAGS = -I$(IODIR) $(ARCHFLAGS) $(PARFLAGS)
#
LIBS = -L$(OBJDIR) -lioapi -lnetcdf $(OMPLIBS) \
$(ARCHLIB) $(ARCHLIBS)
#
VPATH = $(OBJDIR)
#
