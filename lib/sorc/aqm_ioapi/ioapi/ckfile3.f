...
C.........................................................................
C Version "@(#)$Header: /env/proj/archive/cvs/ioapi/./ioapi/src/ckfile3.f,v 1.2 2000/11/28 21:22:32 smith_w Exp $"
...
C...........   Next, checks on the variable-list
     ...
     &              'for variable "' //
     &              VLIST3( U,FID )( 1:TRIMLEN( VLIST3( U,FID ) ) ) // 
     &              '" in file "' // 
     &              FLIST3( FID )( 1:TRIMLEN( FLIST3( FID ) ) ) // '"'
                CALL M3WARN( 'CKFILE3', 0, 0, MESG )
                CKFILE3 = .FALSE.
     ...
     &              VLIST3( V,FID )( 1:TRIMLEN( VLIST3( V,FID ) ) ) // 
     &              '" in file "' // 
     &              FLIST3( FID )( 1:TRIMLEN( FLIST3( FID ) ) ) // '"'
...
111         CONTINUE
     ...
     &                ( VGTYP .NE. VGHVAL3 ) ) THEN

                WRITE( MESG, 94010 ) 
     &         'Illegal vertical grid/coordinate type:', VGTYP,
     &         'in file "' // 
     &          FLIST3( FID )( 1:TRIMLEN( FLIST3( FID ) ) ) // '"'
                CALL M3WARN( 'CKFILE3', 0, 0, MESG )             
                CKFILE3 = .FALSE.
