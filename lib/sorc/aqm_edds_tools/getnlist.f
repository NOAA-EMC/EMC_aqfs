...
C File: @(#)$Id: getnlist.f,v 1.7 2004/06/18 17:20:30 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/getnlist.f,v $
C Last updated: $Date: 2004/06/18 17:20:30 $ 
C
C***************************************************************************
