...
C File: @(#)$Id: chkgrid.f,v 1.14 2005/02/25 20:03:31 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/chkgrid.f,v $
C Last updated: $Date: 2005/02/25 20:03:31 $
C
C***************************************************************************
