!------------------------------------------------------------------------------
!
! 2019-apr-26	jacobi.f:    Original fortran 77 version from Tom Hamill.
!		Originally from Numerical Recipes.
!
! 2019-jun-20	jacobi.f90:  Minimal conversion to fortran 90.  By Dave Allured.
...
SUBROUTINE jacobi(a,n,np,d,v,nrot)
      ...
      double precision, intent(out) :: a(np,np), d(np), v(np,np)
