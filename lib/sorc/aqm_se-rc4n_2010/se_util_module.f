...
C $Header: /project/work/rep/STENEX/src/se_f90/se_util_module.f,v 1.6 2001/01/24 13:13:48 yoj Exp $
...
C -- determine begining and ending row and column indexes, respectively
        ...
        my_begrow = 1
        my_begcol = 1
        my_endrow = se_subgrid_ind(2,1,se_myworker_pe) - se_subgrid_ind(1,1,se_myworker_pe)
     &              + 1
        my_endcol = se_subgrid_ind(2,2,se_myworker_pe) - se_subgrid_ind(1,2,se_myworker_pe)
     &              + 1
