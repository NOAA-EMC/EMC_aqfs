...
C File: @(#)$Id: getfline.f,v 1.4 2004/06/18 17:19:55 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/getfline.f,v $
C Last updated: $Date: 2004/06/18 17:19:55 $ 
C
C****************************************************************************
