...
C                System
C File: @(#)$Id: rdeproc.f,v 1.6 2005/08/22 18:55:38 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/proj/../apps/archive/smoke/smoke/src/lib/rdeproc.f,v $
C Last updated: $Date: 2005/08/22 18:55:38 $ 
C
C***************************************************************************
