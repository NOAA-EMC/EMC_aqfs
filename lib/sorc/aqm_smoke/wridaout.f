...
C                System
C File: @(#)$Id: wridaout.f,v 1.19 2005/08/01 01:49:14 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/wridaout.f,v $
C Last updated: $Date: 2005/08/01 01:49:14 $ 
C
C***************************************************************************
