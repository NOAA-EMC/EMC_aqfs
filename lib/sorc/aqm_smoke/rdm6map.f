...
C                System
C File: @(#)$Id: rdm6map.f,v 1.4 2007/01/26 22:08:26 bbaek Exp $
C
...
C
C Pathname: $Source:
C /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/rdm6map.f,v $
C Last updated: $Date: 2007/01/26 22:08:26 $ 
C
C***************************************************************************
