...
C                System
C File: @(#)$Id: rdmactdsc.f,v 1.1 2005/08/16 16:35:26 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/rdmactdsc.f,v $
C Last updated: $Date: 2005/08/16 16:35:26 $ 
C
C**************************************************************************
