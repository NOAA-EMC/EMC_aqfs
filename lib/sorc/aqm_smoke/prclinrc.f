...
C                System
C File: @(#)$Id: prclinrc.f,v 1.22 2005/10/20 20:41:08 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/prclinrc.f,v $
C Last updated: $Date: 2005/10/20 20:41:08 $ 
C  
C***********************************************************************
