...
C                System
C File: @(#)$Id: wrorlout.f,v 1.2 2005/11/28 03:11:12 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/wrorlout.f,v $
C Last updated: $Date: 2005/11/28 03:11:12 $ 
C
C***************************************************************************
