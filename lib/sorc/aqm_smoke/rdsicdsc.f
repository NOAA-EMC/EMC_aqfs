...
C                System
C File: @(#)$Id: rdsicdsc.f,v 1.4 2005/08/22 18:57:24 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/rdsicdsc.f,v $
C Last updated: $Date: 2005/08/22 18:57:24 $ 
C
C**************************************************************************
