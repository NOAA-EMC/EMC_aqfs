...
C                System
C File: @(#)$Id: genuslst.f,v 1.12 2005/10/02 00:14:34 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/genuslst.f,v $
C Last updated: $Date: 2005/10/02 00:14:34 $ 
C
C***************************************************************************
