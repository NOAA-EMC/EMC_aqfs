...
C                System
C File: @(#)$Id: evalcrit.f,v 1.5 2005/08/16 15:44:08 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/evalcrit.f,v $
C Last updated: $Date: 2005/08/16 15:44:08 $ 
C  
C***********************************************************************
