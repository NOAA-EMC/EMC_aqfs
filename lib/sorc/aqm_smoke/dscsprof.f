...
C                System
C File: @(#)$Id: dscsprof.f,v 1.12 2005/08/22 18:53:17 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/dscsprof.f,v $
C Last updated: $Date: 2005/08/22 18:53:17 $ 
C
C***************************************************************************
