...
C                System
C File: @(#)$Id: rdxclude.f,v 1.7 2005/08/22 18:59:54 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/rdxclude.f,v $
C Last updated: $Date: 2005/08/22 18:59:54 $ 
C
C***************************************************************************
