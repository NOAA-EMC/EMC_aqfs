...
C                System
C File: @(#)$Id: rdsconv.f,v 1.14 2005/08/22 18:57:15 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/rdsconv.f,v $
C Last updated: $Date: 2005/08/22 18:57:15 $ 
C  
C************************************************************************
