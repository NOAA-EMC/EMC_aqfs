...
! File: @(#)$Id: createset.f,v 1.4 2004/06/18 15:46:11 cseppan Exp $
!
...
! smoke@unc.edu
!
! Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/filesetapi/filesetapi/createset.f,v $
! Last updated: $Date: 2004/06/18 15:46:11 $ 
!
!*************************************************************************
