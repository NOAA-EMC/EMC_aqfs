...
!
! 1.05	2022-may-21	Add getnc_dim_sizes.f90.
!
! Notes:
!
...
! a Fortran 90 API, currently 3.5.0 through 4.8.1.
!
!-----------------------------------------------------------------------------

! Include section for routines with their own modules.

   include 'getnc_dim_sizes.f90'
...
! Incorporated by module inheritance.
   ...
   use getnc__dim_sizes
   implicit none

! Visibility controls.  All private, except as declared.

   private

   public check, getnc_dim_size, getnc_dim_sizes
...
! Include section for module routines without their own modules.
