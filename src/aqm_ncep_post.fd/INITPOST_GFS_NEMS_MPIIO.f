...
!jp0  added by jphunag on 5/10/2018 to calcualte PDTOP using ak5, bk5
! here PDTOP is the pressure thickness from transitio layer to model top
!  the tranistion layer is the pressure level where bk5=0
!jp        do l=1,lm
        do l=lm,1,-1
          if ( bk5(l) .eq. 0.0000) then
             pdtop = ak5(l) - ak5(lp1)
          endif
        end do
...
!      print*,"hjp888,pdtop=",pdtop,"pt=",pt
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!     Compute omega
!sk05132016
...
! jphuang 5/10/2018  calcualte the pressure thickness between surface and transition level
      do j=jsta,jend
        do i=1,im
...
!     l=1
      ...
      do j=jsta,jend
        do i=1,im
          if (psfcavg(i,j) /= spval) psfcavg(i,j) = psfcavg(i,j) * 1.0
        enddo
      enddo
!!     if(debugprint)print*,'sample ',VarName,' = ',psfcavg(isa,jsa)
!       print*,"hjp999,psfcavg=",psfcavg(isa,jsa)
!jp9
...
!     if(debugprint)print*,'sample ',VarName,' = ',avgalbedo(isa,jsa)
      print*,'hjp222',VarName,' = ',avgalbedo(isa,jsa)
...
!     if(debugprint)print*,'sample l',VarName,' = ',1,ivgtyp(isa,jsa)
      print*,'hjp111,',VarName,' = ',1,ivgtyp(isa,jsa)
