...
C                System
C File: @(#)$Id: modbeis3.f,v 1.5 2004/08/17 14:24:26 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/emmod/modbeis3.f,v $
C Last updated: $Date: 2004/08/17 14:24:26 $ 
C
C***********************************************************************
