...
! File: @(#)$Id: openset.f,v 1.3 2004/06/18 15:46:56 cseppan Exp $
!
...
! smoke@unc.edu
!
! Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/filesetapi/filesetapi/openset.f,v $
! Last updated: $Date: 2004/06/18 15:46:56 $ 
!
!*************************************************************************
...
!........  Get env. variable setting for ROOTNAME
	 ...
	 ENVNAME=ENVNAME(5:TRIMLEN(ENVNAME))
       ELSE
       CALL NAMEVAL( ROOTNAME16, ENVNAME )
       ENDIF
