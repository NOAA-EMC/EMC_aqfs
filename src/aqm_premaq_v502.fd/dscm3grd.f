...
C File: @(#)$Id: dscm3grd.f,v 1.18 2004/06/22 18:53:46 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/dscm3grd.f,v $
C Last updated: $Date: 2004/06/22 18:53:46 $ 
C
C***************************************************************************
