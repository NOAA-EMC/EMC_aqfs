...
#                      .
# Script name:         exaqm_post1_cb6r3_cs.maxi.sh.ecf
...
EOF5
   ...
   ## file aqm-1hro3-maxi.227.grib2             is aqm.${cycle}.max_1hr_o3.227.grib2
   ## file aqm-8hro3-maxi.227.grib2             is aqm.${cycle}.max_8hr_o3.227.grib2
   for hr in 1 8
   do
   ...
   ########################################################
   ## file aqm.${cycle}.1hpm25-max.227.grib2    is aqm.${cycle}.max_1hr_pm25.227.grib2
   #  daily_1hr_max_PM2.5
   rm -rf filesize
   echo 0 > filesize
   export XLFRTEOPTS="unit_vars=yes"
   ...
   rm filesize
   ## file aqm.${cycle}.24hrpm25-ave.227.grib2  is aqm.${cycle}.ave_24hr_pm25.227.grib2
