     ...
     &  NFILS,NGRDS,NFLDS,JPDS5,JPDS6,JPDS7,JPDS16,JPDS19,
     &  IOUTUN,notcdf,GFS_O3,fnamepre,IRET)  !!Air Quality, PLee
...
C
          if(.not.notcdf.and..not.GFS_O3) then
     ...
     X           'FILE  ',FNAME
             ...
             kfnamepre=index(fname,' ')
             fnamepre(l)(1:kfnamepre)=fname(1:kfnamepre)
          endif
         ENDDO
C
C
