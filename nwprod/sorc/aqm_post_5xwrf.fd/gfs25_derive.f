     ...
     &     O3_sig_bgn(JMAXOT,25),O3_sig_end(JMAXOT,25)
      LOGICAL   LOUT(JMAXOT)
      LOGICAL   continue_search
      character Dn2*3, fnamepre(MAXG)*80, ozonefile*80
      save   i_st_time
      real asigo(25),hgt(46),P_sig(JMAXOT,25),uppres,blpres
     ...
     &   3,   2,   1/
      data asigo/0.0125,0.0380,0.0645,0.0920,0.158,0.2605,
     & 0.3595,0.455,0.5470,0.6180,0.669,0.7185,0.7585,0.7890,
     & 0.8190,0.848,0.8755,0.9015,0.926,0.9490,0.9650,0.9745,
     & 0.9835,0.9915,0.9975/
...
CCPCL
     ...
     &  (P_sig(100,kj),kj=1,25)
      write(6,2332) "O3_sig_end=",
     &  (O3_sig_end(100,kj),kj=1,25)
