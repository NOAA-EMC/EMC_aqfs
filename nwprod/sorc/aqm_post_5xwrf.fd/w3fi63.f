...
C 2003-06-30  GILBERT     ADDED GRIDS 145 and 146 for CMAQ
C                         and GRID 175 for AWIPS over GUAM.
C   04-03-08  OTTE        ADDED GRIDS 140-142,144,146,148-150 FOR AQF.
C   04-03-11  OTTE        ADDED GRIDS 138 FOR AQF 255 for CONUS
C   05-02-08  PLee        REMOVED GRIDS 140-144,149-150, 3x=147,5x=148
C
...
C                 ----- U.S. GRID 127 - MAP SIZE 294912
                  J     = 294912
                  GO TO 800
C***TLO 11 Mar 2004 ***start
              ELSE IF (KPDS(3).EQ.138) THEN
C                  ----- CONUS (5x+) AQF GRID 138 - MAP SIZE 134784
                  J   = 134784
                  GO TO 800
CER              ELSE IF (KPDS(3).EQ.255) THEN
CER                  ----- CONUS (Eric) AQF GRID 255 - MAP SIZE 322980
CER                  J   = 322980
CER                  GO TO 800

               ELSE IF (KPDS(3).EQ.255) THEN
C                  ----- CONUS (5x+) AQF GRID 255 - MAP SIZE 321792
                  J   = 321792
                  GO TO 800

CPL*PLee 08 Feb 2005 ***Comment out starts
C***TLO 11 Mar 2004 ***end
C***TLO 08 Mar 2004 ***start
CPL           ELSE IF (KPDS(3).EQ.140) THEN
C                  ----- EAST (3X) U.S. AQF GRID 140 - MAP SIZE 70470
CPL               J   = 70470
CPL               GO TO 800
CPL           ELSE IF (KPDS(3).EQ.141) THEN
C                  ----- EAST (3X) U.S. AQF GRID 141 - MAP SIZE 71002
CPL               J   = 71002
CPL               GO TO 800
CPL           ELSE IF (KPDS(3).EQ.142) THEN
C                  ----- EAST (3x) U.S. AQF GRID 142 - MAP SIZE 69412
CPL               J   = 69412
CPL               GO TO 800
CPL*PLee 08 Feb 2005 ***renaming Grid 142 to Grid 147 starts
              ELSE IF (KPDS(3).EQ.147) THEN
C                  ----- EAST (3x) U.S. AQF GRID 147 - MAP SIZE 69412
                  J   = 69412
                  GO TO 800
CPL*PLee 08 Feb 2005 ***renaming Grid 142 to Grid 147 ends
CPL           ELSE IF (KPDS(3).EQ.144) THEN
C                  ----- NE U.S. AQF GRID 144 - MAP SIZE 24192
CPL               J   = 24192
CPL               GO TO 800
C***TLO 08 Mar 2004 ***end
...
C***TLO 08 Mar 2004 ***start
CPL*PLee 08 Feb 2005 ***Comment out starts
CPL           ELSE IF (KPDS(3).EQ.148) THEN
C                  ----- CONUS (5X) AQF GRID 148 - MAP SIZE 118548
CPL               J   = 118548
CPL               GO TO 800
CPL           ELSE IF (KPDS(3).EQ.149) THEN
C                  -----  CONUS (5X) AQF GRID 149 - MAP SIZE 119260
CPL               J   = 119260
CPL               GO TO 800
CPL           ELSE IF (KPDS(3).EQ.150) THEN
C                  ----- CONUS (5X) AQF GRID 150 - MAP SIZE 117130
CPL               J   = 117130
CPL               GO TO 800
CPL*PLee 08 Feb 2005 ***renaming Grid 150 to Grid 148 starts
              ELSE IF (KPDS(3).EQ.148) THEN
C                  ----- CONUS (5X) AQF GRID 148 - MAP SIZE 117130
                  J   = 117130
                  GO TO 800
CPL*PLee 08 Feb 2005 ***renaming Grid 150 to Grid 148 ends
C***TLO 08 Mar 2004 ***end
      ...
      ELSE IF (KPDS(1).EQ.7) THEN
          ...
          ELSE IF (KPDS(3).EQ.126.OR.KPDS(3).EQ.127) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
C***PLee 14 Sep 2004 TLO ***start
          ELSE IF (KPDS(3).EQ.138.OR.KPDS(3).EQ.255) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
C***PLee 14 Sep 2004 TLO ***end
