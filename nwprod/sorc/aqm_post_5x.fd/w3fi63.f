...
C   04-03-11  OTTE        ADDED GRIDS 138 AND 139 FOR AQF.
...
CPL           ELSE IF (KPDS(3).EQ.139) THEN
C                  ----- CONUS (5x+) AQF GRID 139 - MAP SIZE 135541
CPL               J   = 135541
CPL               GO TO 800
...
C***PLee 14 Sep 2004 TLO ***start
          ELSE IF (KPDS(3).EQ.138.OR.KPDS(3).EQ.142) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
