...
C 2005-02-08  PLee         ADDED GRIDS 138, 147, 1nd 148 for CMAQ
...
C
      ...
      INTEGER       GRD126(18)
      INTEGER       GRD127(18)
C***TLO 11 Mar 04 ***start
      INTEGER       GRD138(18)
CPL*PLee 08 Feb 2005 ***Comment out starts
CPL   INTEGER       GRD139(18)
C***TLO 11 Mar 04 ***end
C***TLO 08 Mar 04 ***start
CPL   INTEGER       GRD140(18)
CPL   INTEGER       GRD141(18)
CPL   INTEGER       GRD142(18)
CPL*PLee 08 Feb 2005 ***renaming Grid 142 to 147 starts
      INTEGER       GRD147(18)
CPL*PLee 08 Feb 2005 ***renaming Grid 142 to 147 ends
CPL   INTEGER       GRD144(18)
C***TLO 08 Mar 04 ***end
      INTEGER       GRD145(18)
      INTEGER       GRD146(18)
C***TLO 08 Mar 04 ***start
CPL   INTEGER       GRD148(18)
CPL   INTEGER       GRD149(18)
CPL   INTEGER       GRD150(18)
CPL*PLee 08 Feb 2005 ***renaming Grid 150 to 148 starts
      INTEGER       GRD148(18)
CPL*PLee 08 Feb 2005 ***renaming Grid 150 to 148 ends
C***TLO 08 Mar 04 ***end
      INTEGER       GRD170(18)
      INTEGER       GRD171(18)
      INTEGER       GRD172(18)
...
CPL*PLee 08 Feb 2005 ***Comment out starts
CPL   DATA  GRD139/ 0, 255, 3, 469,289,  20953,-123319,   8,   -97000,
CPL  &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
C***TLO 11 Mar 04 ***end
C***TLO 08 Mar 04 ***start
CPL   DATA  GRD140/ 0, 255, 3, 270,261,  24486,-101108,   8,   -97000,
CPL  &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
CPL   DATA  GRD141/ 0, 255, 3, 271,262,  24431,-101163,   8,   -97000,
CPL  &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
CPL   DATA  GRD142/ 0, 255, 3, 268,259,  24595,-100998,   8,   -97000,
CPL  &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
C***PLee 08 Feb 2005 ***renaming Grid 142 to 147 starts
      DATA  GRD147/ 0, 255, 3, 268,259,  24595,-100998,   8,   -97000,
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
C***PLee 08 Feb 2005 ***renaming Grid 142 to 147 ends
CPL   DATA  GRD144/ 0, 255, 3, 168,144,  32233, -90104,   8,   -79500,
CPL  &  12000, 12000, 0, 64, 0, 36000, 46000, 0, 0/
C***PLee 08 Feb 2005 ***Comment out ends
C***TLO 08 Mar 04 ***end
C***TLO 12 Dec 02 ***start
...
C***TLO 08 Mar 04 ***start
     ...
     &  12000, 12000, 0, 64, 0, 36000, 46000, 0, 0/
C***PLee 08 Feb 2005 ***Comment out starts
CPL   DATA  GRD148/ 0, 255, 3, 444,267,  21694,-120707,   8,   -97000,
CPL  &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
CPL   DATA  GRD149/ 0, 255, 3, 445,268,  21630,-120747,   8,   -97000,
CPL  &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
CPL   DATA  GRD150/ 0, 255, 3, 442,265,  21821,-120628,   8,   -97000,
CPL  &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
C***PLee 08 Feb 2005 ***renaming Grid 150 to 148 starts
      DATA  GRD148/ 0, 255, 3, 442,265,  21821,-120628,   8,   -97000,
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
C***PLee 08 Feb 2005 ***renaming Grid 150 to 148 ends
C***PLee 08 Feb 2005 ***Comment out ends
C***TLO 08 Mar 04 ***end
...
1008    CONTINUE
CPL*PLee 08 Feb 2005 ***Comment out starts
CPL   ELSE IF (IGRID.EQ.139) THEN
CPL     DO 1009 I = 1,18
CPL       IGDS(I) = GRD139(I)
CPL 1009    CONTINUE
C***TLO 11 Mar 04 ***end
C***TLO 08 Mar 04 ***start
CPL   ELSE IF (IGRID.EQ.140) THEN
CPL     DO 1108 I = 1,18
CPL       IGDS(I) = GRD140(I)
CPL 1108    CONTINUE
CPL   ELSE IF (IGRID.EQ.141) THEN
CPL     DO 1109 I = 1,18
CPL       IGDS(I) = GRD141(I)
CPL 1109    CONTINUE
CPL   ELSE IF (IGRID.EQ.142) THEN
CPL     DO 1110 I = 1,18
CPL       IGDS(I) = GRD142(I)
CPL 1110    CONTINUE
C***PLee 08 Feb 2005 ***renaming Grid 142 to 147 starts
...
1110    CONTINUE
C***PLee 08 Feb 2005 ***renaming Grid 142 to 147 ends
CPL   ELSE IF (IGRID.EQ.144) THEN
CPL     DO 1208 I = 1,18
CPL       IGDS(I) = GRD144(I)
CPL 1208    CONTINUE
C***TLO 08 Mar 04 ***end
C***TLO 16 Dec 02 ***start
...
C***TLO 08 Mar 04 ***start
      ELSE IF (IGRID.EQ.146) THEN
        DO 1210 I = 1,18
          IGDS(I) = GRD146(I)
1210    CONTINUE
CPL   ELSE IF (IGRID.EQ.148) THEN
CPL     DO 1308 I = 1,18
CPL       IGDS(I) = GRD148(I)
CPL 1308    CONTINUE
CPL   ELSE IF (IGRID.EQ.149) THEN
CPL     DO 1309 I = 1,18
CPL       IGDS(I) = GRD149(I)
CPL 1309    CONTINUE
CPL   ELSE IF (IGRID.EQ.150) THEN
CPL     DO 1310 I = 1,18
CPL       IGDS(I) = GRD150(I)
CPL 1310    CONTINUE
CPL*PLee 08 Feb 2005 ***renaming Grid 150 to 148 starts
...
1310    CONTINUE
CPL*PLee 08 Feb 2005 ***renaming Grid 150 to 148 ends
CPL*PLee 08 Feb 2005 ***Comment out ends
C***TLO 08 Mar 04 ***end
C
