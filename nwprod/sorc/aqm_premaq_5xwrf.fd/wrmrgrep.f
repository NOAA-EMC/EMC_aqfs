...
C                System
C File: @(#)$Id: wrmrgrep.f,v 1.20 2004/09/30 12:52:42 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkmerge/wrmrgrep.f,v $
C Last updated: $Date: 2004/09/30 12:52:42 $ 
C
C****************************************************************************
