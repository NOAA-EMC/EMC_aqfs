...
C                System
C File: @(#)$Id: bldmrgidx.f,v 1.14 2004/07/26 14:08:38 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkmerge/bldmrgidx.f,v $
...
!$omp  parallel do
!$omp& shared(PPSCNT,emnam)
!$omp& private(l1,l2,cbuf,cspc,j,cpol,mesg)
!$omp& firstprivate(sflag,nmspc,nippa)
!$omp& reduction(.and.:eflag)
