...
!     01/05 by David Wong
!       Expanded PEMGRD from a 2D to a 3D variable
!
!***************************************************************************
!
! Project Title: Sparse Matrix Operator Kernel Emissions (SMOKE) Modeling
!                System
! File: @(#)$Id: modmerge.f,v 1.15 2004/06/21 17:23:02 cseppan Exp $
!
...
! smoke@unc.edu
!
! Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/emmod/modmerge.f,v $
