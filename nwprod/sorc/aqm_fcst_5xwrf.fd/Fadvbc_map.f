...
C $Header: /project/cmaq/rel/models/CCTM/src/hadv/hppm/advbc_map.F,v 1.1.1.1 2002/06/27 11:25:50 yoj Exp $
...
C External Functions not previously declared in IODECL3.EXT:
      ...
      INTEGER, EXTERNAL :: FINDEX, INDEX1, TRIMLEN, SETUP_LOGDEV
