...
C-----------------------------------------------------------------------
      ...
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/GC_G2AQ.EXT"             ! gas to aqueous maping table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/AE_A2AQ.EXT"             ! aerosol to aqueous maping table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/NR_N2AQ.EXT"             ! non-reactive to aqueous maping table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/TR_T2AQ.EXT"             ! tracer to aqueous maping table
