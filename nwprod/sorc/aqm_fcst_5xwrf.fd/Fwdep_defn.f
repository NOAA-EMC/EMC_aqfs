...
C-----------------------------------------------------------------------
      ...
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/GC_WDEP.EXT"   ! wet deposition table for gases
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/AE_WDEP.EXT"   ! wet deposition table for aerosols
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/NR_WDEP.EXT"   ! wet deposition table for non-reactives
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/TR_WDEP.EXT"   ! wet deposition table for tracers
