...
C $Header: /project/air5/sjr/CMAS4.5/rel/models/CCTM/src/vdiff/eddy/rddepv.F,v 1.1.1.1 2005/09/09 18:56:06 sjr Exp $
...
!     INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/TR_DEPV.EXT"   ! tracer dep vel surrogate names and map table
      ...
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/GC_SPC.EXT"
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/AE_SPC.EXT"
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/NR_SPC.EXT"
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/NR_N2AE.EXT"
...
C for INTERPX
     ...
     &               0.2611,  1.716, 47.855, 0.865, 11.804 /
      ...
      INTERFACE
         SUBROUTINE AERO_DEPV ( MDATE, MTIME, MSTEP, ADEPV )
            IMPLICIT NONE
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      IF ( N_AE_DEPV .GT. 0 ) THEN
         CALL AERO_DEPV( MDATE, MTIME, MSTEP, ADEPV )
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      DO V = STRT, FINI
         ...
         IF ( ( LAERO3 .OR. LAERO4 ) .AND. SGSPEC( N ) ) CYCLE ! Skip if aero3
                                                    ! or aero4 and SGTOT species
