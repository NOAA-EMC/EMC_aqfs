...
C $Header: /project/air5/sjr/CMAS4.5/rel/models/CCTM/src/driver/yamo/VGRD_DEFN.F,v 1.1.1.1 2005/09/09 18:56:06 sjr Exp $
...
C   1: VGSIGP for sigma-P coordinates
C   2: VGSGP0 for sigma-P0 coordinates
C   3: VGSIGZ for sigma-Z coordinates
C   4: VGETAP for eta-P coordinates
C   5: VGPRES for pressure coordinates
C   6: VGZVAL for Z (meters above ground)
C   7: VHZVAL for H (meters above mean sea level)
C   8: IMISS  for vertical coordinates not stored in VGLVSD
