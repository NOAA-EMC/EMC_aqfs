...
C $Header: /project/air5/sjr/CMAS4.5/rel/models/CCTM/src/init/yamo/load_cgrid.F,v 1.1.1.1 2005/09/09 18:56:06 sjr Exp $ 

C what(1) key, module and SID; SCCS file; date and time of last delta:
C %W% %P% %G% %U%

C:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      SUBROUTINE LOAD_CGRID ( FNAME, JDATE, JTIME, SPC_CAT )
...
C    7 Feb 03 Dave, Jeff: fix subhfile error (overwriting the FDESC common)
C                         replace INTERPX with XTRACT3 (no need to interpolate)
C   23 May 03 Jeff: fix repeated loads of rhoj
C    4 Sep 03 J.Young: fix SPC/NDX bug if ASO4J IC's are unavailable
C   20 Nov 03 J.Young: enable loading RHOJ
C   13 May 04 Jeff: fix closed file MET_CRO_3D for aero
C-----------------------------------------------------------------------
...
!     INCLUDE SUBST_VGRD_ID     ! vertical dimensioning parameters
      ...
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/GC_ICBC.EXT"     ! gas chem ic/bc surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/AE_ICBC.EXT"     ! aerosol ic/bc surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/NR_ICBC.EXT"     ! non-react ic/bc surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/TR_ICBC.EXT"     ! tracer ic/bc surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/GC_G2AE.EXT"     ! gas chem aerosol species and map table
...
C External Functions (not already declared by IODECL3.EXT):
      ...
      INTEGER, EXTERNAL :: SETUP_LOGDEV ! for ancillary log files
