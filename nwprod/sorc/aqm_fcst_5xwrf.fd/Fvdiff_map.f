...
C $Header: /project/air5/sjr/CMAS4.5/rel/models/CCTM/src/vdiff/eddy/vdiff_map.F,v 1.1.1.1 2005/09/09 18:56:06 sjr Exp $
...
!     INCLUDE SUBST_VGRD_ID   ! vertical dimensioning parameters
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/GC_SPC.EXT"    ! gas species table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/GC_EMIS.EXT"   ! gas chem emis surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/GC_DEPV.EXT"   ! gas chem dep vel surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/GC_DDEP.EXT"   ! gas chem dry dep species and map table
...
!     INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/AE_EMIS.EXT"   ! aerosol emis surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/AE_DEPV.EXT"   ! aerosol dep vel surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/AE_DDEP.EXT"   ! aerosol dry dep species and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/AE_DIFF.EXT"   ! aerosol diffusion species and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/NR_SPC.EXT"    ! nr species table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/NR_EMIS.EXT"   ! non-react emis surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/NR_DEPV.EXT"   ! non-react dep vel surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/NR_DDEP.EXT"   ! non-react dry dep species and map table
      ...
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/TR_DEPV.EXT"   ! tracer dep vel surrogate names and map table
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/TR_DDEP.EXT"   ! tracer dry dep species and map table
...
!     INCLUDE SUBST_EMLYRS_ID ! emissions layers parameter
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/PARMS3.EXT"
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/IODECL3.EXT"    ! I/O definitions and declarations ! debug
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      INCLUDE "/nwpara/sorc/aqm_fcst_5xwrf.fd/EMISPRM.vdif.EXT"   ! emissions processing in vdif
