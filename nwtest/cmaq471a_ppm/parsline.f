...
C $Header: /project/work/rep/CCTM/src/vdiff/acm2_inline/parsline.f,v 1.2 2008/08/30 13:32:48 yoj Exp $
...
C File: @(#)$Id: parsline.f,v 1.2 2008/08/30 13:32:48 yoj Exp $
...
C smoke@unc.edu
C Pathname: $Source: /project/work/rep/CCTM/src/vdiff/acm2_inline/parsline.f,v $
