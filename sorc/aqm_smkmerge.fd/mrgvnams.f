...
C                System
C File: @(#)$Id: mrgvnams.f,v 1.17 2004/07/26 14:08:39 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkmerge/mrgvnams.f,v $
...
C----------------------------------------------------------------------
            ...
            DO I = 1, NVARS
              ...
              print*,"hjp111,I=",I,"SPJOIN=",SPJOIN,
     +            "ETJOIN=",ETJOIN
                TDESC  = VDESCS( I )
                L      = INDEX( TDESC, SPJOIN )  ! find species separator
              
              print*,"hjp222,L=",L,"SPJOIN=",SPJOIN,"TDESC=",TDESC
                IF( L .LE. 0 ) THEN
