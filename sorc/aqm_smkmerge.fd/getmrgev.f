...
C                System
C File: @(#)$Id: getmrgev.f,v 1.20 2004/11/04 21:33:18 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkmerge/getmrgev.f,v $
C Last updated: $Date: 2004/11/04 21:33:18 $ 
C
C****************************************************************************
