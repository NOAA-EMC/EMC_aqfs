...
C                System
C File: @(#)$Id: mrgasciielev.f,v 1.7 2005/09/01 03:26:10 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkmerge/mrgasciielev.f,v $
C Last updated: $Date: 2005/09/01 03:26:10 $
C
C***********************************************************************
