...
!
      ...
      character chtmp*2
      integer kpds(200),kgds(200),grib2id(ncmaq),paracat(ncmaq),  &
          mgrib2id(nmet),mparacat(nmet)
      ...
      data cmaqspec(1),grib2id(1),paracat(1),i3dvar(1)/'O3',193,14,.TRUE./
      data cmaqspec(2),grib2id(2),paracat(2),i3dvar(2)/'NO2',142,141,.TRUE./
      data cmaqspec(3),grib2id(3),paracat(3),i3dvar(3)/'NO',141,141,.TRUE./
      data cmaqspec(4),grib2id(4),paracat(4),i3dvar(4)/'NO3',145,141,.TRUE./
      data cmaqspec(5),grib2id(5),paracat(5),i3dvar(5)/'N2O5',143,141,.TRUE./
      data cmaqspec(6),grib2id(6),paracat(6),i3dvar(6)/'HNO3',144,141,.TRUE./
      data cmaqspec(7),grib2id(7),paracat(7),i3dvar(7)/'HONO',147,141,.TRUE./
      data cmaqspec(8),grib2id(8),paracat(8),i3dvar(8)/'PNA',146,141,.TRUE./
      data cmaqspec(9),grib2id(9),paracat(9),i3dvar(9)/'CO',148,141,.TRUE./
      data cmaqspec(10),grib2id(10),paracat(10),i3dvar(10)/'FORM',166,141,.TRUE./
      data cmaqspec(11),grib2id(11),paracat(11),i3dvar(11)/'ALD2',167,141,.TRUE./
      data cmaqspec(12),grib2id(12),paracat(12),i3dvar(12)/'PAN',172,141,.TRUE./
      data cmaqspec(13),grib2id(13),paracat(13),i3dvar(13)/'NTR',173,141,.TRUE./
      data cmaqspec(14),grib2id(14),paracat(14),i3dvar(14)/'ETH',160,141,.TRUE./
      data cmaqspec(15),grib2id(15),paracat(15),i3dvar(15)/'SO2',232,141,.TRUE./
      data cmaqspec(6),grib2id(16),paracat(16),i3dvar(16)/'ISOP',164,141,.TRUE./
      data cmaqspec(17),grib2id(17),paracat(17),i3dvar(17)/'NH3',149,141,.TRUE./
      data cmaqspec(18),grib2id(18),paracat(18),i3dvar(18)/'ASO4I',189,141,.TRUE./  ! my assignment
      data cmaqspec(19),grib2id(19),paracat(19),i3dvar(19)/'ASO4J',200,141,.TRUE./
      data cmaqspec(20),grib2id(20),paracat(20),i3dvar(20)/'ANH4I',190,141,.TRUE./
      data cmaqspec(21),grib2id(21),paracat(21),i3dvar(21)/'ANH4J',201,141,.TRUE./
      data cmaqspec(22),grib2id(22),paracat(22),i3dvar(22)/'ANO3I',191,141,.TRUE./
      data cmaqspec(23),grib2id(23),paracat(23),i3dvar(23)/'ANO3J',202,141,.TRUE./
      data cmaqspec(24),grib2id(24),paracat(24),i3dvar(24)/'AORGAI',192,141,.TRUE./
      data cmaqspec(25),grib2id(25),paracat(25),i3dvar(25)/'AORGAJ',203,141,.TRUE./
      data cmaqspec(26),grib2id(26),paracat(26),i3dvar(26)/'AORGPAI',193,141,.TRUE./
      data cmaqspec(27),grib2id(27),paracat(27),i3dvar(27)/'AORGPAJ',204,141,.TRUE./
      data cmaqspec(28),grib2id(28),paracat(28),i3dvar(28)/'AORGBI',194,141,.TRUE./
      data cmaqspec(29),grib2id(29),paracat(29),i3dvar(29)/'AORGBJ',205,141,.TRUE./
      data cmaqspec(30),grib2id(30),paracat(30),i3dvar(30)/'AECI',195,141,.TRUE./
      data cmaqspec(31),grib2id(31),paracat(31),i3dvar(31)/'AECJ',206,141,.TRUE./
      data cmaqspec(32),grib2id(32),paracat(32),i3dvar(32)/'A25I',196,141,.TRUE./
      data cmaqspec(33),grib2id(33),paracat(33),i3dvar(33)/'A25J',207,141,.TRUE./
      data cmaqspec(34),grib2id(34),paracat(34),i3dvar(34)/'ASOIL',220,141,.TRUE./
      data cmaqspec(35),grib2id(35),paracat(35),i3dvar(35)/'ACORS',221,141,.TRUE./
      data cmaqspec(36),grib2id(36),paracat(36),i3dvar(36)/'PM2.5',193,13,.TRUE./
      data cmaqspec(37),grib2id(37),paracat(37),i3dvar(37)/'XO2N',181,141,.TRUE./
      data cmaqspec(38),grib2id(38),paracat(38),i3dvar(38)/'NUMATKN',222,141,.TRUE./
      data cmaqspec(39),grib2id(39),paracat(39),i3dvar(39)/'NUMACC',223,141,.TRUE./
      data cmaqspec(40),grib2id(40),paracat(40),i3dvar(40)/'SRFATKN',228,141,.TRUE./
      data cmaqspec(41),grib2id(41),paracat(41),i3dvar(41)/'SRFACC',229,141,.TRUE./
      data cmaqspec(42),grib2id(42),paracat(42),i3dvar(42)/'AH2OJ',208,141,.TRUE./
      data cmaqspec(43),grib2id(43),paracat(43),i3dvar(43)/'AH2OI',211,141,.TRUE./
      data cmaqspec(44),grib2id(44),paracat(44),i3dvar(44)/'EXT_Mie',128,141,.TRUE./
      data cmaqspec(45),grib2id(45),paracat(45),i3dvar(45)/'PAR',159,141,.TRUE./
      data cmaqspec(48),grib2id(48),paracat(48),i3dvar(48)/'OLE',161,141,.TRUE./
      data cmaqspec(46),grib2id(46),paracat(46),i3dvar(46)/'TOL',162,141,.TRUE./
      data cmaqspec(47),grib2id(47),paracat(47),i3dvar(47)/'XYL',163,141,.TRUE./
      data cmaqspec(49),grib2id(49),paracat(49),i3dvar(49)/'H2O2',186,141,.TRUE./
      data cmaqspec(50),grib2id(50),paracat(50),i3dvar(1)/'O3_8hr',194,14,.TRUE./
...
!-- section 4: product definition section
      ipdstmpl=0
      ipdsnum=42             ! Product Definition Template Number (Table 4.0) (0:Analysis or forecast at a horizontal level or in a horizontal layer at a pointin time)
...
!      ipdstmpl(2)=193       ! parameter  
       ipdstmpl(1)=paracat(L)       ! catogory
       ipdstmpl(2)=grib2id(L)       ! parameter number
