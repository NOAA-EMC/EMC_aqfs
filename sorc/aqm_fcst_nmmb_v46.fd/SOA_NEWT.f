...
C $Header: /project/air5/sjr/CMAS4.5/rel/models/CCTM/src/aero/aero3/SOA_NEWT.f,v 1.1.1.1 2005/09/09 18:56:04 sjr Exp $
...
c      Res., Vol 106, No D22, 28275-28293, 2001.
      ...
      INTEGER NP
       PARAMETER( NP = 10 ) ! this variable must equal NCVAP !!
...
!bs ** BS ** ** BS ** BS ** ** BS ** BS ** ** BS ** BS ** ** BS ** BS *!
!bs
c    call vector modified to remove NP and set dimensions  to N.   
      IMPLICIT NONE
!bs
      INTEGER N, INDX(N)
...
!bs
      IMPLICIT NONE
!bs
cc   call vector modified to remove NP. All dimensions now depend upon N only.
      INTEGER N, INDX(N)
cc      INTEGER NMAX
