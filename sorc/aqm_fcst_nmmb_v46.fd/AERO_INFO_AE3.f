...
C $Header: /project/work/rep/CCTM/src/aero/aero3/AERO_INFO_AE3.f,v 1.4 2004/09/27 20:19:08 sjr Exp $

C what(1) key, module and SID; SCCS file; date and time of last delta:
C @(#)vdiffim.F 1.8 /project/mod3/CMAQ/src/vdiff/eddy/SCCS/s.vdiffim.F 25 Jul 1997 12:57:45

C:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
c  MODULE AERO_INFO_AE3 contains what was formerlly in include files
c     AEROSTUFF.EXT AND AERO_internal.EXT as well subroutines used in
c     the third version (AE3) of the modal aerosol dynamics model.
c
...
C *** set up indices for the array CBLK
      ...
      INTEGER   VSEAS   ! coarse mode marine aerosol concentration
...
c     Note: neither H2O nor SOA is associated with coarse mode
...
c   Model !. Model decsription and preliminary Results, Journal of
