...
C                System
C File: @(#)$Id: grdmat.f,v 1.23 2005/07/20 19:08:52 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/grdmat/grdmat.f,v $
C Last updated: $Date: 2005/07/20 19:08:52 $ 
C
C***************************************************************************
