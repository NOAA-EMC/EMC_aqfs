...
C                System
C File: @(#)$Id: setfrac.f,v 1.9 2004/06/28 14:17:09 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/grdmat/setfrac.f,v $
C Last updated: $Date: 2004/06/28 14:17:09 $ 
C
C***************************************************************************
