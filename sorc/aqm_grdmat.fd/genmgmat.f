...
C                System
C File: @(#)$Id: genmgmat.f,v 1.12 2004/06/27 02:00:31 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/grdmat/genmgmat.f,v $
C Last updated: $Date: 2004/06/27 02:00:31 $ 
C
C***************************************************************************
