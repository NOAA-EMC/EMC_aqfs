...
C                System
C File: @(#)$Id: opengmat.f,v 1.10 2004/07/26 13:43:02 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/grdmat/opengmat.f,v $
C Last updated: $Date: 2004/07/26 13:43:02 $ 
C
C***************************************************************************
