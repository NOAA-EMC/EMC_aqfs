...
C                System
C File: @(#)$Id: blkorcmt.f,v 1.4 2004/06/03 14:36:40 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/lib/blkorcmt.f,v $
C Last updated: $Date: 2004/06/03 14:36:40 $ 
C  
C***********************************************************************
