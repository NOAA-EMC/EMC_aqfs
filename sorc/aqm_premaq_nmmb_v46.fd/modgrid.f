...
! File: @(#)$Id: modgrid.f,v 1.7 2004/06/18 17:17:17 cseppan Exp $ 
!
...
! smoke@unc.edu
!
! Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/modules/modgrid.f,v $ 
! Last updated: $Date: 2004/06/18 17:17:17 $ 
!
!****************************************************************************
...
!AQF        CHARACTER(IOVLEN3), PUBLIC :: COORD = ' '  ! coord system name
        ...
        INTEGER, PUBLIC :: NCOLS_E = 0      ! number of columns in grid
        INTEGER, PUBLIC :: NROWS_E = 0      ! number of rows in grid
...
!.........  Vertical structure information
        INTEGER, PUBLIC :: NLAYS_E = 1       ! number of layers
