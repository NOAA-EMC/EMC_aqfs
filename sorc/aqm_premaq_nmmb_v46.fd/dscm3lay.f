...
C File: @(#)$Id: dscm3lay.f,v 1.3 2004/06/18 17:24:00 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/dscm3lay.f,v $
C Last updated: $Date: 2004/06/18 17:24:00 $ 
C
C***************************************************************************
