...
C                System
C File: @(#)$Id: mxgrpemis.f,v 1.12 2005/08/16 15:45:51 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/point/mxgrpemis.f,v $
C Last updated: $Date: 2005/08/16 15:45:51 $ 
C  
C***********************************************************************
