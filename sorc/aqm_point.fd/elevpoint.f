...
C                System
C File: @(#)$Id: elevpoint.f,v 1.22 2005/08/16 15:45:27 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/point/elevpoint.f,v $
C Last updated: $Date: 2005/08/16 15:45:27 $
C  
C***********************************************************************
