...
C                System
C File: @(#)$Id: fire_postplm.f,v 1.1 2005/03/30 01:29:30 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/point/fire_postplm.f,v $
C Last updated: $Date: 2005/03/30 01:29:30 $ 
C
C***********************************************************************
