...
C                System
C File: @(#)$Id: plmris.f,v 1.7 2005/03/30 01:30:25 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/point/plmris.f,v $
C Last updated: $Date: 2005/03/30 01:30:25 $ 
C  
C***********************************************************************
