...
C                System
C File: @(#)$Id: openeout.f,v 1.12 2005/02/25 18:16:39 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/point/openeout.f,v $
C Last updated: $Date: 2005/02/25 18:16:39 $ 
C  
C***********************************************************************
