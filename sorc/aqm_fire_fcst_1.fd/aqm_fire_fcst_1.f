...
c     6 tfrac(maxnf,numrec,kmax)
     ...
     2 chdtmp*2,firespec(8)*12      
      ...
      integer, allocatable, dimension (:,:) :: intime
      integer, allocatable, dimension (:,:) :: lstk 
      integer, allocatable, dimension (:,:) :: lpbl
      integer, allocatable, dimension (:,:) :: ltop
       
      real, allocatable, dimension  (:,:) :: hmix
      real, allocatable, dimension  (:,:) :: psfc  
      real, allocatable, dimension  (:,:) :: tsfc        
      real, allocatable, dimension  (:,:) :: tstk
      real, allocatable, dimension  (:,:) :: wstk  
      real, allocatable, dimension  (:,:) :: ustmp
      real, allocatable, dimension  (:,:) :: hfx
      real, allocatable, dimension  (:,:) :: tmpbflx  
      ...
      real, allocatable, dimension  (:,:,:) :: zstk
...
chc for diagnosis
      ...
      allocate(lbot(maxnf,numrec),STAT=ierr)
chc for diagnosis
