...
C                System
C File: @(#)$Id: wrpdemis.f,v 1.11 2004/06/27 02:07:01 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkinven/wrpdemis.f,v $
