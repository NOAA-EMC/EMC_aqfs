        ...
        SUBROUTINE RDSRCEMSAR( LINE, CFIP, TSCC, NPOLPERLN, 
     &                         HDRFLAG, EFLAG )
...
C
C  DESCRIPTION:
C      This subroutine processes a line from an EMS-95 format area-source inventory
...
C
C  REVISION  HISTORY:
C      Created by C. Seppanen (01/03) based on rdemsar.f
C
C**************************************************************************
C
C Project Title: Sparse Matrix Operator Kernel Emissions (SMOKE) Modeling
C                System
C File: @(#)$Id: rdsrcemsar.f,v 1.5 2004/06/21 17:30:10 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkinven/rdsrcemsar.f,v $
C Last updated: $Date: 2004/06/21 17:30:10 $ 
C
C***************************************************************************
...
C.........  Replace blanks with zeros        
        ...
        TSCC = ADJUSTL( LINE( 6:20  ) )            ! SCC code
