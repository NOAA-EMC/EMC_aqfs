...
C                System
C File: @(#)$Id: wrepinven.f,v 1.4 2004/06/21 17:30:10 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkinven/wrepinven.f,v $
