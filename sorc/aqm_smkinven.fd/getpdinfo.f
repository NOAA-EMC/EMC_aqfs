...
C                System
C File: @(#)$Id: getpdinfo.f,v 1.11 2004/06/21 17:30:07 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkinven/getpdinfo.f,v $
C Last updated: $Date: 2004/06/21 17:30:07 $ 
C
C***************************************************************************
