...
C                System
C File: @(#)$Id: rdsrcntinp.f,v 1.5 2005/08/14 17:18:25 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkinven/rdsrcntinp.f,v $
