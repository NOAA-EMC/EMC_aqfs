...
C                System
C File: @(#)$Id: wrinvemis.f,v 1.14 2005/09/01 15:34:28 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkinven/wrinvemis.f,v $
