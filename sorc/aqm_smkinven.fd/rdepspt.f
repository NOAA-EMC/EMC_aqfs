...
C                System
C File: @(#)$Id: rdepspt.f,v 1.15 2004/06/27 02:07:01 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkinven/rdepspt.f,v $
C Last updated: $Date: 2004/06/27 02:07:01 $ 
C
C***************************************************************************

C...........   MODULES for public variables
C...........   This module is the inventory arrays
        USE MODSOURC, ONLY: IFIPA, ISICA, TPFLGA, INVYRA, STKHTA, STKDMA,
     &                      STKTKA, STKVEA, XLOCAA, YLOCAA, CSCCA,
     &                      CORISA, CBLRIDA, CPDESCA, POLVLA, CSOURCA

C.........  This module contains the lists of unique inventory information
        USE MODLISTS, ONLY: MXIDAT, INVDCOD, INVDNAM

C.........  This module contains the information about the source category
        USE MODINFO, ONLY: NEM, NDY, NCE, NRE, NC1
