        ...
        SUBROUTINE RDEPSAR( FDEV, NRAWIN, WKSET, INY, NRAWOUT, IOS, 
...
C                System
C File: @(#)$Id: rdepsar.f,v 1.12 2004/06/27 02:07:01 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkinven/rdepsar.f,v $
