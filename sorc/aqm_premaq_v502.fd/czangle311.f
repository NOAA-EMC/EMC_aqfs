...
C                System
C File: @(#)$Id: czangle.f,v 1.1 1999/11/23 13:37:45 vukovich Exp $
C
...
C
C Pathname: $Source: /env/proj/archive/cvs/smoke/smoke/src/biog/czangle.f,v $
C Last updated: $Date: 1999/11/23 13:37:45 $ 
C
C***********************************************************************
...
C...........   INCLUDES:
        ...
        INCLUDE 'EMCNST3.EXT'     !
C        INCLUDE 'BIODIMS3.EXT'    ! biogenic-related constants
