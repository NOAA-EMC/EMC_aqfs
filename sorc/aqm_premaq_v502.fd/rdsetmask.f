...
C File: @(#)$Id: rdsetmask.f,v 1.3 2004/06/18 17:22:12 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/rdsetmask.f,v $
