...
C                System
C File: @(#)$Id: mrgonams.f,v 1.13 2004/07/26 14:08:39 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkmerge/mrgonams.f,v $
