...
C File: @(#)$Id: openphys.f,v 1.3 2004/06/18 17:21:17 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/openphys.f,v $
C Last updated: $Date: 2004/06/18 17:21:17 $
C
C***************************************************************************
