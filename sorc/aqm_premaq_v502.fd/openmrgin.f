...
C                System
C File: @(#)$Id: openmrgin.f,v 1.21 2004/06/21 17:30:31 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkmerge/openmrgin.f,v $
...
C...........  This module contains the information about the source category
        USE MODINFO, ONLY: NMAP, MAPNAM, MAPFIL,KNIPPA

C.........  This module contains arrays for plume-in-grid and major sources
        USE MODELEV, ONLY: NGROUP, NHRSRC

C.........  This module contains the global variables for the 3-d grid
        USE MODGRID, ONLY: GRDNM, VGTYP, VGTOP, VGLVS
...
C.........  This module is required for the FileSetAPI
        ...
        USE MOD_TEMPORAL, ONLY: PVNAMES, PVUNITS
...
!AQF        IF( .NOT. DSCM3GRD( GDNAM3D, GDESC, COORD3D, GDTYP3D, COORUN3D,
!AQF     &                      P_ALP3D, P_BET3D, P_GAM3D, XCENT3D, YCENT3D,
!AQF     &                      XORIG3D, YORIG3D, XCELL3D, YCELL3D,
!AQF     &                      NCOLS3D, NROWS3D, NTHIK3D ) ) THEN

!AQF            MESG = 'Could not get Models-3 grid description.'
!AQF            CALL M3EXIT( PROGNAME, 0, 0, MESG, 2 )
!AQF        END IF

!AQF        CALL CHKGRID( 'general', 'GRIDDESC', 1, EFLAG )  ! May get initlzd here
            ...
            SDATE3D = premaq_sdate    ! added 12/20/04
	    STIME3D = premaq_stime    ! added 12/20/04 for AQF
...
C.........  Prompt for and open inventory file 
     ...
     &            'POINT INVENTORY file'
            INAME = PENAME
!AQF this file has already been read in pre_laypoint
!AQF            IDEV = PROMPTFFILE( MESG, .TRUE., .TRUE., INAME, PROGNAME )



C.........  Read map-formatted inventory file
! this file has already been opened in pre_laypoint
!AQF            CALL RDINVMAP( INAME, IDEV, PENAME, DUMNAME, PSDEV )
             PENAME = ENAME
	     DUMNAME = ANAME
	     PSDEV = SDEV
...
!AQF not needed
!AQF                CALL OPEN_TMP_FILES( 'POINT', PFLAG_BD, PTNAME, PSDATE)


                PNIPOL = KNIPPA  ! AQF NVARSET = NIPPA in opentmp.f
...
! get VNAMES and INVINFO set PEINAM, PONAMES, POUNITS

!AQF                CALL STORE_VNAMES( 1, 1, PNIPOL, .TRUE., PEINAM )
		
		PEINAM(1:PNIPOL) = PVNAMES(1:PNIPOL)
		
	 
                  
!AQF                CALL STORE_INVINFO( 1, 1, PNIPOL, 1, INVPIDX, .TRUE., 
!AQF     &                              PONAMES, POUNITS )

                     PONAMES(1:PNIPOL) = PVNAMES(1:PNIPOL)
		     POUNITS(1:PNIPOL) = PVUNITS(1:PNIPOL)
...
!  file already opened in pre_temporal
!        CDEV = PROMPTFFILE( 
...
!AQF            CALL GETM3EPI( TZONE, SDATE, STIME, TSTEP, NSTEPS )

!AQF            SDATE = premaq_sdate
!AQF            STIME = premaq_stime
...
!AQF                IF( TFLAG .AND. NSTEPS .LE. 0 ) THEN
!AQF		    write (*,*) TFLAG, NSTEPS, SDATE,STIME, EDATE, ETIME
		
!AQF                    MESG = 'Because of file ' // FILNAM // 
!AQF     &                     ', dates and times do not overlap at all!'
!AQF                    CALL M3EXIT( PROGNAME, 0, 0, MESG, 2 )
