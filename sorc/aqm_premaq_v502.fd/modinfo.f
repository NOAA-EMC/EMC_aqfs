...
!                System
! File: @(#)$Id: modinfo.f,v 1.16 2004/06/21 17:23:02 cseppan Exp $
!
...
! smoke@unc.edu
!
! Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/emmod/modinfo.f,v $
...
!.........  Source-category-specific variables
	...
	INTEGER,     PUBLIC :: KNIPPA = 0  ! global (added by GAP for AQF)	
