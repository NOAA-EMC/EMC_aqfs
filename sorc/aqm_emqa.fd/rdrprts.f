...
C                System
C File: @(#)$Id: rdrprts.f,v 1.14 2005/10/20 20:53:54 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/emqa/rdrprts.f,v $
C Last updated: $Date: 2005/10/20 20:53:54 $ 
C  
C***********************************************************************
