...
C                System
C File: @(#)$Id: asgnbins.f,v 1.16 2005/10/21 13:44:33 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/emqa/asgnbins.f,v $
C Last updated: $Date: 2005/10/21 13:44:33 $ 
C  
C***********************************************************************
