...
C                System
C File: @(#)$Id: wrrephdr.f,v 1.17 2005/10/21 13:45:00 cseppan Exp $
C  
...
C smoke@unc.edu
C  
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/emqa/wrrephdr.f,v $
C Last updated: $Date: 2005/10/21 13:45:00 $ 
C  
C***********************************************************************
