...
C                System
C File: @(#)$Id: opentmpin.f,v 1.18 2004/06/27 02:09:04 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/temporal/opentmpin.f,v $
C Last updated: $Date: 2004/06/27 02:09:04 $ 
C
C***************************************************************************
