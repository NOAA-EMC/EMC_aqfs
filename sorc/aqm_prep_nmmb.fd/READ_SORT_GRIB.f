...
C
         ...
         ELSE
c          KBYTES = JSTAT(11)
           KBYTES = JSTAT(8)                 !! aqm_Prdgen  May_013
           PRINT *,TRIM(NFILE),'NUMBER OF BYTES IN GRIB FILE = ',KBYTES
         END IF
C
...
C
         ...
         END IF
C
cyt print out control file request
         WRITE(6,"('master control file request ',i4)")NFLDS
         DO N=1,NFLDS
          WRITE(6,'(5I8)') JPDS5(N),JPDS6(N), JPDS7(N), JPDS16(N), JPDS19(N) 
         ENDDO
...
C
     ...
     &      + MOVA2I(IBUF(I+6)) 
         ...
         DO N=1,NFLDS
!jp            if ( IPDS5 .EQ. 182 ) then
!jp               print*,"jp0,N=",N,"I,JPDS5=",IPDS5,JPDS5(N),"I,JIPDS6="
!jp     &           ,IPDS6,JPDS6(N),"I,JPDS7=",IPDS7,JPDS7(N)
!jp     &           ,"I,JPDS16=",IPDS16,JPDS16(N)
!jp     &           ,"I,JPDS19=",IPDS19,JPDS19(N)
!jp           end if
