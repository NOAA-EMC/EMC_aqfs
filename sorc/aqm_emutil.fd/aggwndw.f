...
C                System
C File: @(#)$Id: aggwndw.f,v 1.6 2005/08/16 15:43:13 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/emutil/aggwndw.f,v $
C Last updated: $Date: 2005/08/16 15:43:13 $ 
C
C*************************************************************************
