...
C                System
C File: @(#)$Id: extractida.f,v 1.4 2005/07/20 19:08:23 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/emutil/extractida.f,v $
