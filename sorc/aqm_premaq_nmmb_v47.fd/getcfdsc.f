...
C File: @(#)$Id: getcfdsc.f,v 1.6 2004/06/18 17:22:42 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/getcfdsc.f,v $
C Last updated: $Date: 2004/06/18 17:22:42 $ 
C
C****************************************************************************
