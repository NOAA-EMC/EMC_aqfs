...
C                System
C File: @(#)$Id: wmrgelev.f,v 1.11 2004/06/27 02:08:00 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/smkmerge/wmrgelev.f,v $
C Last updated: $Date: 2004/06/27 02:08:00 $ 
C
C****************************************************************************
...
C.........  This module contains the global variables for the 3-d grid
        USE MODGRID, ONLY: XCELL, YCELL, XORIG, YORIG,
