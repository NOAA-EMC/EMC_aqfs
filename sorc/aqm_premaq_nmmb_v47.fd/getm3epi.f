...
C File: @(#)$Id: getm3epi.f,v 1.8 2004/09/12 22:36:52 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/getm3epi.f,v $
C Last updated: $Date: 2004/09/12 22:36:52 $
C
C****************************************************************************
