...
C File: @(#)$Id: hdrmiss3.f,v 1.5 2004/06/18 17:20:41 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/edss_tools/edss_tools/src/lib/hdrmiss3.f,v $
C Last updated: $Date: 2004/06/18 17:20:41 $ 
C
C****************************************************************************
