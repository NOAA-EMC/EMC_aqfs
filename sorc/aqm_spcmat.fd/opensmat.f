...
C                System
C File: @(#)$Id: opensmat.f,v 1.12 2004/06/21 17:30:43 cseppan Exp $
C
...
C smoke@unc.edu
C
C Pathname: $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/src/spcmat/opensmat.f,v $
C Last updated: $Date: 2004/06/21 17:30:43 $ 
C
C***************************************************************************
...
C...........   LOCAL PARAMETERS
        CHARACTER(50), PARAMETER :: CVSW = '$Name: SMOKE_v2_2_11282005 $'  ! CVS revision tag
