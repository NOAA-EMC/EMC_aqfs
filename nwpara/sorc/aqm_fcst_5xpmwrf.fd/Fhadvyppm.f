...
C  18 Sep 2007: Jeff Young - move call to RDBCON; add (commented out) debug writes
...
!           REAL,    INTENT( IN )  :: BCON( NBNDY,* )
         ...
         SUBROUTINE X_YAMO ( FDATE, FTIME, TSTEP, LVL, BCON, MTRHOJ )
            USE GRID_CONF
            IMPLICIT NONE
            INTEGER, INTENT( IN )  :: FDATE, FTIME, TSTEP, LVL
!           REAL,    INTENT( IN )  :: BCON( NBNDY,* )
...
!           REAL,    INTENT( IN )  :: BCON( NBNDY,: )
         ...
         SUBROUTINE Y_YAMO ( FDATE, FTIME, TSTEP, LVL, BCON, MTRHOJ )
            USE GRID_CONF
            IMPLICIT NONE
            INTEGER, INTENT( IN )  :: FDATE, FTIME, TSTEP, LVL
