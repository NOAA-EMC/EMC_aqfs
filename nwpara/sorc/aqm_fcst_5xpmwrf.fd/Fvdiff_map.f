...
!     INCLUDE SUBST_VGRD_ID   ! vertical dimensioning parameters
      INCLUDE "/meso/save/wx20jy/cctm/BLD_u5a/GC_SPC.EXT"    ! gas species table
...
!     INCLUDE "/meso/save/wx20jy/cctm/BLD_u5a/AE_EMIS.EXT"   ! aerosol emis surrogate names and map table
      ...
      INCLUDE "/meso/save/wx20jy/cctm/BLD_u5a/NR_SPC.EXT"    ! nr species table
...
!     INCLUDE SUBST_EMLYRS_ID ! emissions layers parameter
      INCLUDE "/meso/save/wx20dw/tools/ioapi_3/ioapi/fixed_src/PARMS3.EXT"
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      INCLUDE "/meso/save/wx20dw/tools/ioapi_3/ioapi/fixed_src/IODECL3.EXT"    ! I/O definitions and declarations ! debug
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
