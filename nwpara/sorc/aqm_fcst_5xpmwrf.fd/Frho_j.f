...
C $Header: /project/work/rep/CCTM/src/hdiff/multiscale/rho_j.F,v 1.7 2002/06/22 15:18:54 yoj Exp $ 
...
C                      INTERPX and PINTERPB; allocatable arrays ...
...
C currently not implemented: case where only one origin component matches file's
         ...
         LCB = 0; HCB = MY_NCOLS + 1
         LRB = 0; HRB = MY_NROWS + 1
         MLAYS = SIZE ( RHOJI,3 )
