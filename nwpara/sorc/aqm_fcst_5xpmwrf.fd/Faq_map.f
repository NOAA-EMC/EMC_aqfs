...
C $Header: /project/air5/sjr/CMAS4.5/rel/models/CCTM/src/cloud/cloud_acm/aq_map.F,v 1.1.1.1 2005/09/09 18:56:05 sjr Exp $
...
C-----------------------------------------------------------------------
      ...
      INCLUDE "/meso/save/wx20jy/cctm/BLD_u5a/GC_G2AQ.EXT"             ! gas to aqueous maping table
      INCLUDE "/meso/save/wx20jy/cctm/BLD_u5a/AE_A2AQ.EXT"             ! aerosol to aqueous maping table
      INCLUDE "/meso/save/wx20jy/cctm/BLD_u5a/NR_N2AQ.EXT"             ! non-reactive to aqueous maping table
      INCLUDE "/meso/save/wx20jy/cctm/BLD_u5a/TR_T2AQ.EXT"             ! tracer to aqueous maping table
...
C # of species used in Aqeuous module
      INTEGER, PARAMETER :: N_CGRID2AQD = N_GC_G2AQD
     &                                  + N_AE_A2AQ
     &                                  + N_NR_N2AQ
     &                                  + N_TR_T2AQ

C # of species used in Aqeuous module
      INTEGER, PARAMETER :: N_CGRID2AQ = N_GC_G2AQ
     &                                 + N_AE_A2AQ
     &                                 + N_NR_N2AQ
     &                                 + N_TR_T2AQ
...
C...........LOCAL VARIABLES
      ...
      CHARACTER( 16 ), SAVE :: CGRID2AQ( N_CGRID2AQD ) ! CGRID species used in AQCHEM
      ...
      INTEGER, SAVE :: LSGRGAS( NGAS,MXSPCS ) ! pointers in CGRID to each gas
      INTEGER, SAVE :: LSGRAER( NAER,MXSPCS ) ! pointers in CGRID to each aerosol
      INTEGER, SAVE :: CGRID2AQ_MAP( N_CGRID2AQD ) ! CGRID map to aqueous species
...
C...........EXTERNAL FUNCTIONS
      ...
      INTEGER, EXTERNAL :: INDEXN, TRIMLEN ! funcs to get species pointers and
                                           ! string length, excl. trailing blanks
