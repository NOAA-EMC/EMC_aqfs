...
C $Header: /project/air5/sjr/CMAS4.5/rel/models/CCTM/src/cloud/cloud_acm/rescld.F,v 1.1.1.1 2005/09/09 18:56:05 sjr Exp $
...
C      11 29 Oct 05 J.Young: for CMAQ-F
C
C  Called by:  CLDPROC
C
...
!    &                         DEP( COL, ROW, N_SPC_WDEP+1 ) + REMOVAC
                TOT_DEP( COL, ROW, N_SPC_WDEP+1 ) =
     &                         TOT_DEP( COL, ROW, N_SPC_WDEP+1 ) + REMOVAC
