...
C $Header: /project/air5/sjr/CMAS4.5/rel/models/CCTM/src/driver/yamo/hcontvel.F,v 1.1.1.1 2005/09/09 18:56:06 sjr Exp $ 
...
C    INTERPX, PINTERPB, M3EXIT, TIME2SEC, SEC2TIME, NEXTIME
...
C define communication pattern
         ...
         CALL SE_COMM ( DENSJ, DSPL_N0_E0_S0_W1, DRCN_W, COMMSTR )
         DO ROW = 1, MY_NROWS
            DO COL = 1, MY_NCOLS+1
...
C define communication pattern
         ...
         CALL SE_COMM ( DENSJ, DSPL_N0_E0_S1_W0, DRCN_S, COMMSTR )
         DO ROW = 1, MY_NROWS+1
            DO COL = 1, MY_NCOLS
