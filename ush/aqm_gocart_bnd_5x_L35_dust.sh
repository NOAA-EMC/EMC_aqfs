...
export METEO3D=$outdir/aqm.t12z.metcro3d.ncf
export BND1=$FIXaqm/bnd.conus-12km.static_geos_200604.35L.ncf


export BND2=$outdir/bnd-ngac-dust.$cyear$cmonth$cdate.5x-35L.ncf        # output bnd files
export CHECK2D=$outdir/check-ngac-dust.$cyear$cmonth$cdate.5x-35L.ncf

$EXECaqm/ngac-bnd-nemsio.met1   # dust only
