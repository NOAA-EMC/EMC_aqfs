...
$WGRIB $COMNMM/namrr.t${cyc}z.bgrd3d${fhr}.tm00 | grep -F -f ${FORT21} | $WGRIB -i -grib inputs_${fhr}.grib $COMNMM/namrr.t${cyc}z.bgrd3d${fhr}.tm00 > ${pgmout}.${fhr}.$h_seg 2>errfile
